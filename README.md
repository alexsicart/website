...
> Official website for IPFS http://alexsicart.com
...
To deploy the site alexsicart.com, run:
...
# Update the dns record for alexsicart.com to point to the new ipfs hash.
...
Update the DNS record for `alexsicart.com`.  _(requires an `auto.token` file to be saved in the project root.)_
